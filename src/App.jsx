...
Dzisiaj wiem, że to nie było optymalne rozwiązanie... </> } />,
  ...
  <InternshipSection key="int2" number={2} title="Praktyka w zakładzie przemysłowym - klasa 4." screenshot={praktyki2} kolor="#7d77e5" tekstkolor="#ffffff" description="Druga moja praktyka w tym samym zakładzie produkcyjnym. Tym razem moim zadaniem było zwizualizowanie osób, które będąc na danej zmianie w pracy, mają uprawnienia ratowników medycznych i/lub pożarowych.
Aplikacja pobierała dane z bazy RCP, z biblioteki zdjęć, z bazy szkoleń, z bazy pracowników. Warunkując przypadki system wyświetlał dane konkretnych osób. Dodać należy, że system był wielowymiarowy - operował niezależnie na 8 działach produkcyjnych oraz na 2 modelach pracy (zmianowa i administracyjna)."/>,
