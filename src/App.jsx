...
const SLIDES = [
  ...
  <InternshipSection key="int1" number={1} title="Praktyka w zakładzie przemysłowym - klasa 3." screenshot={praktyki1} kolor="#ffffff" description={ <>W ramach praktyk stworzyłem system monitorujący parametry pracy układu farbowego w drukarni wklęsłodrukowej. System pobiera dane z bazy, do której są wprowadzane poprzez liczne czujniki (poziom farby, przepływ, parametry farby...). Wizualizacja odbywa się on-line z częstotliwością równą próbkowaniu przez czujniki. 
